        ...
        <form action="<?= site_url('peminjaman') ?>" method="get" class="row g-2">
            ...
            <div class="col-md-2">
                <select name="status" class="form-select" style="border-radius: 10px;">
                    ...
                    <option value="diajukan" <?= request()->getGet('status') == 'diajukan' ? 'selected' : '' ?>>Diajukan</option>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($total_denda > 0 || $t['status_bayar'] == 'lunas') : ?>
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <span class="badge <?= ($t['status_bayar'] == 'lunas') ? 'bg-success' : (($t['status_bayar'] == 'proses') ? 'bg-info' : 'bg-secondary') ?>" style="font-size: 9px; border-radius: 4px; padding: 2px 6px;">
                                            <?= ($t['status_bayar'] == 'lunas') ? 'Lunas' : (($t['status_bayar'] == 'proses') ? 'Proses' : 'Belum Bayar') ?>
                                        </span>
                                    </div>
                                <?php else : ?>
...
<div class="modal fade" id="modalBayar" tabindex="-1" aria-labelledby="modalBayarLabel" aria-hidden="true" style="z-index: 9999;">
    ...
    <form action="" id="formBayar" method="post" enctype="multipart/form-data" class="w-100">
        <div class="modal-content" style="border-radius: 24px; border: none; box-shadow: 0 10px 40px rgba(0,0,0,0.1);">
          ...
          <div class="modal-header border-0 pt-4 px-4 d-flex flex-column align-items-center">
            <h5 class="fw-bold mb-0" id="modalBayarLabel" style="color: #2d3436;">Pengembalian & Denda</h5>
            <button type="button" class="btn-close position-absolute" data-bs-dismiss="modal" aria-label="Close" style="right: 25px; top: 25px;"></button>
          </div>
          ...
          <div class="modal-body px-4 pb-4">
            ...
            <div id="sectionUpload" style="display: none;">
                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <div class="p-3 border rounded-4 bg-light text-center h-100 d-flex flex-column justify-content-center align-items-center" 
                             ...
                             onmouseover="this.style.backgroundColor='#f0f7ff'; this.style.borderColor='#3182ce'" 
                             onmouseout="this.style.backgroundColor='#f8f9fa'; this.style.borderColor='#e2e8f0'">
                    ...
                    <div class="col-6">
                        <a href="https://link.dana.id/send-money/081234567890" target="_blank" class="text-decoration-none">
                            <div class="p-3 border rounded-4 bg-light text-center h-100 d-flex flex-column justify-content-center align-items-center" 
                                 ...
                                 onmouseover="this.style.backgroundColor='#ebf8ff'; this.style.borderColor='#3182ce'" 
                                 onmouseout="this.style.backgroundColor='#f8f9fa'; this.style.borderColor='#e2e8f0'">
                ...
                <div class="alert alert-info py-2 px-3 mb-4 d-flex align-items-center" style="font-size: 11px; border-radius: 12px; border: none; background-color: #e3f2fd;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php endif; ?>
    // ... (rest of your swal code)
});

// Logic konfirmasi admin & hapus (Sama persis)
...
function showDetailDenda(tglDeadline, tglKembali, totalDenda) {
    ...
    Swal.fire({
        ...
        html: `<div class="text-start p-2" style="font-size: 14px;">
                ...
                <div class="d-flex justify-content-between mb-1"><span>Tarif Denda:</span><span>Rp ${tarif.toLocaleString('id-ID')} / hari</span></div>
...
function copyRekening(nomor, bank) {
    navigator.clipboard.writeText(nomor).then(() => {
        Swal.fire({
            ...
            position: 'center', 
            // Menghilangkan backdrop ganda agar tidak makin gelap
            backdrop: false, 
            didOpen: () => {
                // Set z-index gila-gilaan biar di depan modal putih lu
